...
BOT_TOKEN = environ.get('BOT_TOKEN', '7931367906:AAEdd-I6M-iDekw-jsFYezdi6ZqIB6rFFN8')
#---------------------------------------------------------------
#---------------------------------------------------------------
...
DATABASE_NAME = environ.get('DATABASE_NAME', "latest&moves")
COLLECTION_NAME = environ.get('COLLECTION_NAME', 'Leatekd')
#---------------------------------------------------------------
#---------------------------------------------------------------
